...
public class GetPlaneValuesActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener {

    private GoogleMap mMap;
    LocationManager locationManager;
    LocationListener locationListener;
    Context context = GetPlaneValuesActivity.this;
    ...
    public void onMapClick(@NonNull LatLng latLng) {
        ...
        if(count == 1){
            ...
            mMap.addMarker(new MarkerOptions().position(userLocation2).title("Location 1").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_RED)));
